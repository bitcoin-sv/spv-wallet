...
type Destination struct {
	...
	PaymailExternalDerivationNum uint32 `json:"paymail_external_derivation_num" toml:"paymail_external_derivation_num" yaml:"paymail_external_derivation_num" gorm:"<-:create;type:int not null;comment:This is the chain/(num)/(ext_derivation_num) location of the address related to the xPub" bson:"paymail_external_derivation_num"`
