...
// xpubsCreateOld will make a new model using the services defined in the action object
// Create xPub godoc
// @DeprecatedRouter /v1/admin/xpub [post]
// @Summary		Create xPub
...
// xpubsSearchOld will fetch a list of xpubs filtered by metadata
// Search for xpubs filtering by metadata godoc
// @DeprecatedRouter /v1/admin/xpubs/search [post]
...
// @DeprecatedRouter /v1/admin/xpubs/count [post]
// @Summary		Count xpubs
