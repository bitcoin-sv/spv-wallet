...
// @Tags		Transactions
// @Produce		json
// @Param		CountTransactions body actions.CountTransactions false "Enables precise filtering of resource counts using custom conditions or metadata, catering to specific business or analysis needs"
