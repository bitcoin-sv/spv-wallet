...
// @Tags		Transactions
// @Produce		json
// @Param		SearchTransactions body actions.SearchTransactions false "Supports targeted resource searches with filters for metadata and custom conditions, plus options for pagination and sorting to streamline data exploration and analysis"
