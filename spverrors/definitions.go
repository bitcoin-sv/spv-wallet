...
// ErrMissingXpub is when the xpub field is required but missing
var ErrMissingXpub = errors.New("missing required field: xpub")

// ErrMissingAddress  is when the address field is required but missing
