...
type ComplexityRoot struct {
	...
	Mutation struct {
		...
		XpubWithToken   func(childComplexity int, xpub string, token string, metadata bux.Metadata) int
	}
...
type MutationResolver interface {
	...
	XpubWithToken(ctx context.Context, xpub string, token string, metadata bux.Metadata) (*bux.Xpub, error)
...
func (e *executableSchema) Complexity(typeName, field string, childComplexity int, rawArgs map[string]interface{}) (int, bool) {
	...
	case "Mutation.xpub_with_token":
		if e.complexity.Mutation.XpubWithToken == nil {
			break
		}

		args, err := ec.field_Mutation_xpub_with_token_args(context.TODO(), rawArgs)
		if err != nil {
			return 0, false
		}

		return e.complexity.Mutation.XpubWithToken(childComplexity, args["xpub"].(string), args["token"].(string), args["metadata"].(bux.Metadata)), true
...
func (ec *executionContext) field_Mutation_xpub_with_token_args(ctx context.Context, rawArgs map[string]interface{}) (map[string]interface{}, error) {
	var err error
	args := map[string]interface{}{}
	var arg0 string
	if tmp, ok := rawArgs["xpub"]; ok {
...
func (ec *executionContext) _Mutation_xpub_with_token(ctx context.Context, field graphql.CollectedField) (ret graphql.Marshaler) {
	defer func() {
		if r := recover(); r != nil {
			ec.Error(ctx, ec.Recover(ctx, r))
			ret = graphql.Null
	...
	ctx = graphql.WithFieldContext(ctx, fc)
	rawArgs := field.ArgumentMap(ec.Variables)
	args, err := ec.field_Mutation_xpub_with_token_args(ctx, rawArgs)
	if err != nil {
		ec.Error(ctx, err)
		return graphql.Null
	}
	...
	resTmp, err := ec.ResolverMiddleware(ctx, func(rctx context.Context) (interface{}, error) {
		ctx = rctx // use context from middleware stack in children
		return ec.resolvers.Mutation().XpubWithToken(rctx, args["xpub"].(string), args["token"].(string), args["metadata"].(bux.Metadata))
	})
	if err != nil {
		ec.Error(ctx, err)
		return graphql.Null
...
func (ec *executionContext) _Mutation(ctx context.Context, sel ast.SelectionSet) graphql.Marshaler {
	...
	for i, field := range fields {
		...
		case "xpub_with_token":
			innerFunc := func(ctx context.Context) (res graphql.Marshaler) {
				return ec._Mutation_xpub_with_token(ctx, field)
			}
